    ...
    if (interaction.customId == "open-ticket") {
      ...
      interaction.guild.channels.create(`ticket-${interaction.user.username}`, {
        ...
        const embed = new client.discord.MessageEmbed()
          .setColor('6d6ee8')
          .setAuthor({name: `${interaction.user.username}'s Order`})
        ...
        const row = new client.discord.MessageActionRow()
          .addComponents(
            ...
            .setPlaceholder('Please select your payment method of choice:')
            .addOptions([{
            ...
            if (msg.deletable) {
              msg.delete().then(async () => {
                const embed = new client.discord.MessageEmbed()
                  ...
                  .setDescription(`<@!${interaction.user.id}> Created a ticket to 
                  \`${i.values[0]}\``)
                  .setFooter({text: `${client.user.tag}`, iconURL: client.user.displayAvatarURL()})
                  .setTimestamp();
                ...
                if (i.values[0] === "Purchased with Bitcoin"){
                  sus = "Bitcoin"
                }

                if (i.values[0] === "Purchased with Litecoin"){
                  sus = "Litecoin"
                }

                if (i.values[0] === "Purchased with Ethereum"){
                  sus = "Ethereum"
                }
                ...
                if(col) {
                  let embed = new client.discord.MessageEmbed()
                    .setTitle("Payment method chosen")
                  .setDescription('You have chosen to pay with '+ sus)
                  .setColor('6d6ee8')
                  .setFooter({text: `${client.user.tag}`, iconURL: client.user.displayAvatarURL()})
                  .setTimestamp();
                ...
                if(col) {
                  let embed = new client.discord.MessageEmbed()
                  .setDescription(`Welcome to your order, <@!${interaction.user.id}>! \n At any point to cancel, type \`/close\` `)
                  .setColor('6d6ee8')
                  .setFooter({text: `${client.user.tag}`, iconURL: client.user.displayAvatarURL()})
                  .setTimestamp();
